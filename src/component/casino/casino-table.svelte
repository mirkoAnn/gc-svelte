        ...
        <td class="casino-table-td casino-table-bonus-td">
          <div class="bonus-container">
            ...
            >
              ...
              <span class="mobile-bonus-value"
                >{casino.welcomeBonus.noDeposit}</span
              >
            </a>
          </div>
          <div
            id="disclaimer-no-deposit-{casino.id}"
        ...
        <td class="casino-table-td casino-table-bonus-td">
          <div class="bonus-container">
            ...
            >
              ...
              <span class="mobile-bonus-value"
                >{casino.welcomeBonus.withDeposit}</span
              >
            </a>
          </div>
          <div
            id="disclaimer-with-deposit-{casino.id}"
            class="disclaimer-container"
          >
            <button
              onclick={() => {
