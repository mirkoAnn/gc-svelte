...
<footer class="footer-outer">
  <div class="footer-inner">
    <div class="footer-column">
      <NavBranding />
      <p class="footer-text">Pagina web di slot e casino online</p>
      <p class="footer-text">Gioca Responsabilmente +18 anni</p>
    </div>
    <div class="footer-column">
      {#each navManager.getMenuItemByIndex(0).submenuItems as item}
        <a href={item.href} class="footer-link">{item.label}</a>
      {/each}
    </div>
    <div class="footer-column">
      {#each navManager.getMenuItemByIndex(1).submenuItems as item}
        <a href={item.href} class="footer-link">{item.label}</a>
      {/each}
    </div>
    <div class="footer-column">
      <a href="/privacy-policy" class="footer-link">Policy Privacy</a>
  ...
  <div class="subfooter">
    ...
    <a
      href="https://www.adm.gov.it/portale/giochi"
      class="footer-link"
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Link to ADM website"
    >
