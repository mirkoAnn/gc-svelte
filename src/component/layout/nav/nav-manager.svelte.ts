        ...
        submenuItems: [
          {
            href: `/casino-online`,
            title:
              "Scopri tutti i migliori casino online in Italia" +
        ...
        submenuItems: [
          {
            href: `/slot-gratis`,
            title:
              "Scopri tutte le migliori slot online in Italia" +
              new Date().getFullYear(),
            label: "Tutte le Slot",
            category: "slot",
          },
          {
            ...
            title:
              "Scopri tutte le migliori slot classiche online in Italia" +
              new Date().getFullYear(),
          ...
          },
          {
            ...
            title:
              "Scopri tutte le migliori slot VLT online in Italia" +
              new Date().getFullYear(),
            label: "Slot VLT",
            category: "vlt",
          },
          ...
          },
          {
            ...
            title:
              "Scopri tutte le nuove slot online in Italia" +
              new Date().getFullYear(),
            label: "Nuove Slot",
            category: "nuove",
          },
        ...
        submenuItems: [
          {
            ...
            title:
              "Scopri tutte le migliori roulette online in Italia" +
              new Date().getFullYear(),
    ...
    (context: any) => {
      ...
      if (newActionIndex === -1) {
        ...
        buttonsAnimation
          ...
          .fromTo(
            ".nav-action-" +
              (newActionIndex !== -1 ? newActionIndex : activeActionIndex),
          ...
          .fromTo(
            ".nav-action-" +
              newActionIndex +
              " .nav-action-close .nav-action-close-icon",
            { scale: 0 },
            { scale: 1 },
            "<",
          )
  ...
  if (newSubmenuIndex !== -1) {
    menuAnimation = gsap
      ...
      .to(".nav-links-panel-" + activeSubmenuIndex, {
        height: document.querySelector(".nav-links-panel-" + activeSubmenuIndex)
          ?.scrollHeight,
      })
      .fromTo(
...
const switchBetweenSubmenus = (newMenuIndex: number) => {
  ...
  menuAnimation = gsap
    ...
    .to(
      ...
      {
        height: document.querySelector(".nav-links-panel-" + newMenuIndex)
          ?.scrollHeight,
      },
      "<",
    )
    ...
    (context: any) => {
      ...
      menuAnimation = gsap
        ...
        .to(
          ".nav-section-toggler",
          {
            backgroundColor: isDesktop
              ? menuItems.find((item) => item.section === currentSection)
                  ?.selectorColor
              : menuItems.find((item) => item.section === currentSection)
                  ?.color,
          },
        ...
        .to(
          ...
          {
            xPercent:
              navManager.getMenuSections().indexOf(currentSection) * 100,
            duration: 0.5,
            ease: "back.out(1.7)",
          },
          "<",
        ...
        .to(
          ".nav-section-toggler-button:not(.nav-section-toggler-button-" +
            currentSection +
            ")",
          {
            color: "inherit",
        ...
        .to(
          ".nav",
          {
            backgroundColor: menuItems.find(
        ...
        .to(
          ".nav-links-menu:not(.nav-links-menu-" +
            currentSection +
            ") .nav-links-menu-item",
          {
            xPercent: -100,
...
export const navManager = {
  ...
  getMenuItemByIndex: (index: number) => {
    return (
      menuItems.find((item) => item.section === currentSection)?.items[
        index
      ] || { label: "", category: "", submenuItems: [] }
    );
  },
  getActiveMenuIndex: () => {
  ...
  toggleMenu: (newActionIndex: number) => {
    ...
    if (newActionIndex === activeActionIndex || newActionIndex === -1) {
      ...
      newActionIndex !== activeActionIndex &&
      activeActionIndex === -1
    ) {
  ...
  toggleSubmenu: (newSubmenuIndex: number) => {
    ...
    if (newSubmenuIndex === activeSubmenuIndex || newSubmenuIndex === -1) {
      ...
      newSubmenuIndex !== activeSubmenuIndex &&
      activeSubmenuIndex === -1
    ) {
